            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <div class="d-flex text-end">
                        <a href="<?php echo URL_BASE . 'cliente/create'; ?>" class="btn btn-roxo mx-1" title="Adicionar novo"><i
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table categoria">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $l->limite_credito; ?></td>
                                <td align="center">
                                    <a href="<?php echo URL_BASE . 'cliente/edit/' . $l->id_cliente; ?>" class="btn d-inline-block btn-outline-roxo"><i
                                            class="fas fa-edit"></i>
                                        Editar</a>


                                    <a href="javascript:;" onclick="excluir(this)" data-entidade="cliente"
                                        data-id="<?php echo $l->id_cliente; ?>" class="btn d-inline-block btn-outline-vermelho ml-1">
                                        Excluir
                                    </a>
                                </td>
                            </tr>
