            ...
            <div id="tab">
                <form action="<?php echo URL_BASE . "cliente/salvar" ?>" method="post">                   
                    <div class="col-12 mb-4">
                        <fieldset>
                            ...
                            <div class="rows center-middle">
                                ...
                                <div class="col-4 mb-3" >
                                    <label class="text-label">Digite o e-mail</label>
                                    <div class="grupo-form-btn">
                                        <input type="text" id="pesq_email"  class="form-campo">
                                    </div>
                                </div>
                                <div class="col-2 mt-4 mb-3">
                                    <input type="button" onclick="pesquisarPessoa('cliente')" value="Pesquisar "
                        ...
                        <div class="p-2">
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    ...
                                    <select name="tipo_pessoa" id="tipo_pessoa" class="form-campo"  onchange="tipoCliente()">
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <input type="text" name="cpf_cnpj" id="cpf_cnpj" value="<?php echo $cliente->cpf_cnpj ?? null ?>"
                                        class="form-campo">
                                </div>
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="nome_razao_social" id="nome_razao_social" required
                                        value="<?php echo $cliente->nome_razao_social ?? null ?>" class="form-campo">
                                </div>
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <input type="text"name="apelido_fantasia"  id="apelido_fantasia"
                                        value="<?php echo $cliente->apelido_fantasia ?? null ?>" class="form-campo">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label" id="lblInscEstadual">RG/Inscrição Estadual</label>
                                    <input type="text"  name="rg_ie" maxlength="14" id="rg_ie"
                                        value="<?php echo $cliente->rg_ie ?? null ?>" class="form-campo">
                                </div>
                                <div class="col-2 mb-3">
                                    <label class="text-label">Telefone:</label>
                                    <input type="text" id="telefone" name="telefone" value="<?php echo $cliente->telefone ?? null ?>" class="form-campo mascara-celular">
                                </div>

                                <div class="col-6 mb-3">
                                    <label class="text-label">Email</label>
                                    <input type="text" id="email" name="email" value="<?php echo $cliente->email ?? null ?>"
                                        class="form-campo">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label">Limite de Crédito:</label>
                                    <input type="text" name="limite_credito" value="<?php echo $cliente->limite_credito ?? null ?>" class="form-campo mascara-float">
                                </div>
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    ...
                                    <div class="input-grupo">
                                        <input type="text" value=" <?php echo $cliente->cep ?? null ?>" name="cep" id="cep"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="logradouro" id="logradouro"
                                        value=" <?php echo $cliente->logradouro ?? null ?>" class="form-campo rua">
                                </div>
                                ...
                                <div class="col-2 mb-2">
                                    ...
                                    <input type="text" name="ibge" id="ibge" value="<?php echo $cliente->ibge ?? null ?>"
                    ...
                    <div class="col-12 text-center pb-4">
                        <input type="hidden" value="<?php echo $cliente->id_pessoa ?? null ?>" name="id_pessoa" >
