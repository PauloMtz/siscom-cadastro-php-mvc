    ...
    <div class="col-12">
        ...
        <div class="caixa">
            ...
            <div class="px-2 py-2 w-100 d-grid">
                ...
                <div class=" <?php echo isset($categoria->categoria) ? 'bg-edit' : 'caixafield'; ?>  p-2 pt-0 radius-4">
                    <div class="rows center-middle">
                        <div class="col-9">
                            <label class="text-label d-block text-branco">Nome </label>
                            <input type="text" name="categoria" value="<?php echo $categoria->categoria ?? null; ?>"
                                class="form-campo">
                        </div>
                        <div class="col-3 mt-0 pt-4">
                            <input type="hidden" name="id_categoria" value="<?php echo $categoria->id_categoria ?? null ?>" >
        ...
        <div class="tabela-responsiva pb-4">
            <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table categoria">
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="center"><?php echo $l->id_categoria; ?></td>
                        <td align="left"><?php echo $l->categoria; ?></td>
                        <td align="center">
                            <a href="<?php echo 'categoria/edit/'. $l->id_categoria ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i
                                    class="fas fa-edit"></i>
                                Editar</a>
                            <a href="javascript:;" onclick="excluir(this)" data-entidade="categoria"
                                data-id="<?php echo $l->id_categoria; ?>" class="btn d-inline-block btn-outline-vermelho ml-1">
                                Excluir
                            </a>
