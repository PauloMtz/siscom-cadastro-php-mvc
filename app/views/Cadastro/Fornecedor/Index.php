            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <div class="d-flex text-end">
                        <a href="<?php echo URL_BASE . 'fornecedor/create'; ?>" class="btn btn-roxo mx-1" title="Adicionar novo"><i
                ...
                <div class="tabela-responsiva pb-4">
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table categoria">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center"><?php echo $l->id_fornecedor; ?></td>
                                ...
                                <td align="center">
                                    <a href="<?php echo URL_BASE . 'fornecedor/edit/' . $l->id_fornecedor; ?>" class="btn d-inline-block btn-outline-roxo"><i
                                            class="fas fa-edit"></i>
                                        Editar</a>


                                    <a href="javascript:;" onclick="excluir(this)" data-entidade="fornecedor"
                                        data-id="<?php echo $l->id_fornecedor; ?>" class="btn d-inline-block btn-outline-vermelho ml-1">
                                        Excluir
                                    </a>
                                </td>
                            </tr>
