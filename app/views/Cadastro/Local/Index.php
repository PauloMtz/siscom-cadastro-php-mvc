    ...
    <div class="col-12">
        ...
        <div class="caixa">
            ...
            <div class="px-2 py-2 w-100 d-grid">
                ...
                <div class=" <?php echo isset($local->local) ? 'bg-edit' : 'caixafield'; ?>  p-2 pt-0 radius-4">
                    <div class="rows center-middle">
                        <div class="col-9">
                            <label class="text-label d-block text-branco">Nome </label>
                            <input type="text" name="nome" value="<?php echo $local->nome ?? null; ?>" required
                                class="form-campo">
                        </div>
                        <div class="col-3 mt-0 pt-4">
                            <input type="hidden" name="id_local" value="<?php echo $local->id_local ?? null ?>">
...
<div class="col-12">
    <div class="px-0">
        <div class="tabela-responsiva pb-4">
            <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table local">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="center"><?php echo $l->id_local; ?></td>
                        <td align="left"><?php echo $l->nome; ?></td>
                        <td align="center">
                            <a href="<?php echo URL_BASE .'local/edit/'. $l->id_local ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i
                                    class="fas fa-edit"></i>
                                Editar</a>
                            <a href="javascript:;" onclick="excluir(this)" data-entidade="local"
                                data-id="<?php echo $l->id_local; ?>" class="btn d-inline-block btn-outline-vermelho ml-1">
                                Excluir
                            </a>
