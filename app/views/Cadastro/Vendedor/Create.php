            ...
            <div id="tab">
                <form action="<?php echo URL_BASE . "vendedor/salvar" ?>" method="post">                   
                    ...
                    <fieldset>
                            ...
                            <div class="rows center-middle">
                                ...
                                <div class="col-2 mt-4 mb-3">
                                    <input type="button" onclick="pesquisarPessoa('vendedor')" value="Pesquisar "
                        ...
                        <div class="p-2">
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    <label class="text-label">Tipo Vendedor</label>
                                    <select name="tipo_pessoa" id="tipo_pessoa" class="form-campo"  onchange="tipoVendedor()">
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <input type="text" name="cpf_cnpj" id="cpf_cnpj" value="<?php echo $vendedor->cpf_cnpj ?? null ?>"
                                        class="form-campo">
                                </div>
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="nome_razao_social" id="nome_razao_social" required
                                        value="<?php echo $vendedor->nome_razao_social ?? null ?>" class="form-campo">
                                </div>
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <input type="text" name="apelido_fantasia"  id="apelido_fantasia"
                                        value="<?php echo $vendedor->apelido_fantasia ?? null ?>" class="form-campo">
                                </div>

                                <div class="col-2 mb-3">
                                    <label class="text-label" id="lblInscEstadual">RG/Inscrição Estadual</label>
                                    <input type="text" name="rg_ie" maxlength="14" id="rg_ie"
                                        value="<?php echo $vendedor->rg_ie ?? null ?>" class="form-campo">
                                </div>
                                <div class="col-2 mb-3">
                                    <label class="text-label">Telefone:</label>
                                    <input type="text" id="telefone" name="telefone" value="<?php echo $vendedor->telefone ?? null ?>" class="form-campo mascara-celular">
                                </div>

                                <div class="col-6 mb-3">
                                    <label class="text-label">Email</label>
                                    <input type="text" id="email" name="email" value="<?php echo $vendedor->email ?? null ?>"
                                        class="form-campo">
                                </div>
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    ...
                                    <div class="input-grupo">
                                        <input type="text" value=" <?php echo $vendedor->cep ?? null ?>" name="cep" id="cep"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="logradouro" id="logradouro"
                                        value=" <?php echo $vendedor->logradouro ?? null ?>" class="form-campo rua">
                                </div>
                                <div class="col-2 mb-4">
                                    <label class="text-label">Numero</label>
                                    <input type="text" name="numero" id="numero" value="<?php echo $vendedor->numero ?? null ?>"
                                        class="form-campo ">
                                </div>
                                <div class="col-2 mb-2">
                                    <label class="text-label">UF</label>
                                    <input type="text" name="uf" id="uf" value="<?php echo $vendedor->uf ?? null ?>"
                                        class="form-campo estado">
                                </div>
                                <div class="col-3 mb-3">
                                    <label class="text-label">Complemento</label>
                                    <input type="text" name="complemento" id="complemento"
                                        value="<?php echo $vendedor->complemento ?? null ?>" class="form-campo">
                                </div>
                                <div class="col-3 mb-3">
                                    <label class="text-label">Bairro</label>
                                    <input type="text" name="bairro" id="bairro" value="<?php echo $vendedor->bairro ?? null ?>"
                                        class="form-campo bairro ">
                                </div>

                                <div class="col-4 mb-2">
                                    <label class="text-label">Cidade</label>
                                    <input type="text" name="cidade" id="cidade" value="<?php echo $vendedor->cidade ?? null ?>"
                                        class="form-campo cidade">
                                </div>
                                <div class="col-2 mb-2">
                                    <label class="text-label">IBGE</label>
                                    <input type="text" name="ibge" id="ibge" value="<?php echo $vendedor->ibge ?? null ?>"
                    ...
                    <div class="col-12 text-center pb-4">
                        <input type="hidden" value="<?php echo $vendedor->id_pessoa ?? null ?>" name="id_pessoa" >
                        <input type="hidden" value="<?php echo $vendedor->id_vendedor ?? null ?>" name="id_vendedor" >
