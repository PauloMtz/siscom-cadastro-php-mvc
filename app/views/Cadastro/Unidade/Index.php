            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                   <form action="<?php echo   URL_BASE .'unidade/salvar' ?>" method="POST">
                    ...
                    <div class="<?php echo   isset($unidade->unidade) ? 'bg-edit' : 'caixafield' ?>  p-2 radius-4 border">
                        <div class="   p-2 pt-0 radius-4">
                            <div class="rows center-middle">
                                <div class="col-6">
                                    <label class="text-label d-block text-branco">Nome </label>
                                    <input type="text" name="unidade" value="<?php echo   $unidade->unidade ?? null ?>"
                                        class="form-campo">
                                </div>
                                <div class="col-3">
                                    <label class="text-label d-block text-branco">Abrev </label>
                                    <input type="text" name="abrev" value="<?php echo   $unidade->abrev ?? null?>"
                                        class="form-campo">
                                </div>
                                <div class="col-3 mt-0 pt-4">
                                <input type="hidden" name="id_unidade" value="<?php echo $unidade->id_unidade ?? null ?>" >
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table unidade">
                        ...
                        <tbody>
                            <?php foreach ($lista as $l) { ?>
                                <tr>
                                    <td align="center"><?php echo   $l->id_unidade ?></td>
                                    <td align="left"><?php echo   $l->unidade ?></td>
                                    <td align="left"><?php echo   $l->abrev ?></td>
                                    <td align="center">
                                        <a href="<?php echo  URL_BASE .'unidade/edit/'. $l->id_unidade ?>"
                                            class="d-inline-flex gap-3 btn btn-outline-roxo btn-pequeno"><i
                                                class="fas fa-edit"></i>
                                            Editar
                                        </a>

                                        <a href="javascript:;" onclick="excluir(this)" data-entidade="unidade"
                                            data-id="<?php echo $l->id_unidade; ?>" class="btn d-inline-block btn-outline-vermelho ml-1">
                                            Excluir
                                        </a>
                                    </td>
                                </tr>
