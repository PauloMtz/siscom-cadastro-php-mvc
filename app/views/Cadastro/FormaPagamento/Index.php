    ...
    <div class="rows">
        <div class="col-12 mb-4">
            ...
            <a href="<?php echo   URL_BASE .'formapagamento/gerar' ?>" class="btn btn-roxo mx-1" title="Gerar Forma de Pagamento "><i
        ...
        <div class="col-12">
            <div class="px-0">
                <div class="tabela-responsiva pb-4">
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table formapagamento">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($lista as $l) { ?>
                                <tr>
                                    <td align="center"><?php echo   $l->id_forma_pagamento  ?></td>
                                    <td align="left"><?php echo   $l->forma_pagamento ?></td>
