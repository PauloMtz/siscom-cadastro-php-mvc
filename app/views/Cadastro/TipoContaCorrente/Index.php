        ...
        <div class="col-12">
            ...
            <div class="caixa">
                ...
                <div class="px-2 py-2 w-100 d-grid">
                    <form action="<?php echo   URL_BASE .'tipocontacorrente/salvar/' ?>" method="POST">
                        <div
                            class="<?php echo   isset($tipocontacorrente->tipo_conta_corrente) ? 'bg-edit' : 'caixafield' ?>   p-2 radius-4 border">
                            <div class="   p-2 pt-0 radius-4">
                                <div class="rows center-middle">
                                    <div class="col-9">
                                        <label class="text-label d-block text-branco">Nome </label>
                                        <input type="text" name="tipo_conta_corrente"
                                            value="<?php echo   $tipocontacorrente->tipo_conta_corrente ?? null ?>"
                                            class="form-campo">
                                    </div>
                                    <div class="col-3 mt-0 pt-4">
                                        <input type="hidden" name="id_tipo_conta_corrente" value="<?php echo $tipocontacorrente->id_tipo_conta_corrente ?? null ?>" >
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%" class="table tipocontacorrente">
                        ...
                        <tbody>
                            <?php foreach ($lista as $l) { ?>
                                <tr>
                                    <td align="center"><?php echo   $l->id_tipo_conta_corrente  ?></td>
                                    <td align="left"><?php echo   $l->tipo_conta_corrente ?></td>
                                    <td align="center">
                                        <a href="<?php echo   URL_BASE .'tipocontacorrente/edit/'. $l->id_tipo_conta_corrente  ?>"
                                            class="d-inline-flex gap-3 btn btn-outline-roxo btn-pequeno"><i
                                                class="fas fa-edit"></i>
                                            Editar</a>

                                        <a href="javascript:;" onclick="excluir(this)" data-entidade="tipocontacorrente"
                                            data-id="<?php echo $l->id_tipo_conta_corrente ; ?>" class="btn d-inline-block btn-outline-vermelho ml-1">
                                            Excluir
                                        </a>
                                    </td>
                                </tr>
